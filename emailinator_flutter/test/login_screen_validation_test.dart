...
void main() {
  ...
  testWidgets('LoginScreen shows validation errors when fields empty', (tester) async {
  ...
  testWidgets('LoginScreen moves focus from email to password on submit of email field', (tester) async {
    await tester.pumpWidget(_wrap(LoginScreen()));
