...
export const REQUIREMENT_LEVELS = ["NONE", "OPTIONAL", "VOLUNTEER", "MANDATORY"];
...
export async function extractDeduplicatedTasks(
  ...
  const apiCostNano = promptTokens * INPUT_NANO_USD_PER_TOKEN + completionTokens * OUTPUT_NANO_USD_PER_TOKEN;
  console.info(
